 ...
 * ---------------------
 * Program Details:
 *  Uses LCD Module to display ADC Reading
 * Inputs: RA0 analog in.
 * Outputs: RD0-RD7 LCD Control, RB0 RB1 LCD Control
 * Date: 5 / 1 / 2024
 * File Dependencies / Libraries:<xc.h>, <stdio.h>, <stdlib.h>
 * Compiler: xc8, 2.46
 * Author: Bjorn Lavik
 * Versions:
 *      V1.0:   4/29/2024.      Got System Working with code provided
 *      V1.1    5/1/2024.       Edited header
 */
...
{       
    ...
    while(1){
        ...
        LCD_String_xy(1,0,"Input Voltage:");/*Send string data for printing*/
